...
class SACAgent:
    def __init__(self, env, q_nets, q_target_nets, policy_net,
                 ...
                 batch_size=64, sample_threshold=10000, update_target_interval=1):
        """
...
agent = SACAgent(env, q_nets, q_target_nets, policy_net,
                 ...
                 tau=0.01, batch_size=32, batches=1, update_target_interval=1,
                 auto_alpha=True, alpha=0.3, sample_threshold=random_explore_times,
                 )
